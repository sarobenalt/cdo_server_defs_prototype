...
public class CDOServerDefItemProvider extends ItemProviderAdapter implements
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAcceptorsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Acceptors feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAcceptorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_CDOServerDef_acceptors_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_CDOServerDef_acceptors_feature",
						"_UI_CDOServerDef_type"),
				CDOServerDefsPackage.Literals.CDO_SERVER_DEF__ACCEPTORS, true,
	...
	protected void addRepositoriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_CDOServerDef_repositories_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_CDOServerDef_repositories_feature",
						"_UI_CDOServerDef_type"),
