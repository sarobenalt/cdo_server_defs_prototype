...
/**
 * This is the action bar contributor for the Net4jUtilDefs model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Net4jUtilDefsActionBarContributor extends
	 ...
	 * @generated
	 */
	public Net4jUtilDefsActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("net4jutildefs-settings"));
		toolBarManager.add(new Separator("net4jutildefs-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				Net4jUtilDefsEditorPlugin.INSTANCE
						.getString("_UI_Net4jUtilDefsEditor_menu"),
				"org.eclipse.net4j.util.defsMenuID");
