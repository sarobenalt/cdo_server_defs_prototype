...
/**
 * This is the action bar contributor for the CDODefs model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CDODefsActionBarContributor extends
	 ...
	 * @generated
	 */
	public CDODefsActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("cdodefs-settings"));
		toolBarManager.add(new Separator("cdodefs-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				CDODefsEditorPlugin.INSTANCE
						.getString("_UI_CDODefsEditor_menu"),
				"org.eclipse.emf.cdo.defsMenuID");
