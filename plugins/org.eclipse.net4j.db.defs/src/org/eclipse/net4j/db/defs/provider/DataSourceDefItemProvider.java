...
public class DataSourceDefItemProvider
	 ...
	 * @generated
	 */
	public DataSourceDefItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSourceDef_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSourceDef_class_feature", "_UI_DataSourceDef_type"),
				 Net4jDbDefsPackage.Literals.DATA_SOURCE_DEF__CLASS,
				 true,
				 false,
				 false,
	...
	protected void addDbUsernamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSourceDef_dbUsername_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSourceDef_dbUsername_feature", "_UI_DataSourceDef_type"),
				 Net4jDbDefsPackage.Literals.DATA_SOURCE_DEF__DB_USERNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDbPasswordPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSourceDef_dbPassword_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSourceDef_dbPassword_feature", "_UI_DataSourceDef_type"),
				 Net4jDbDefsPackage.Literals.DATA_SOURCE_DEF__DB_PASSWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((DataSourceDef)object).getDbUsername();
		return label == null || label.length() == 0 ?
			getString("_UI_DataSourceDef_type") :
			getString("_UI_DataSourceDef_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataSourceDef.class)) {
